...
public class UpiDlqConsumer {
    ...
    @RabbitListener(queues = RabbitMQProperties.UPI_DLQ)
    public void consume(PaymentEvent event) {
        System.err.println("[UPI-DLQ] Dead lettered: " + event.getReceiverId()
        ...
        System.err.println("[UPI-DLQ] Saved to database for manual review.");
