...
public class CardDlqConsumer {
    ...
    @RabbitListener(queues = RabbitMQProperties.CARD_DLQ)
    public void consume(PaymentEvent event) {
        System.err.println("[CARD-DLQ] Dead lettered: " + event.getReceiverId()
        ...
        System.err.println("[CARD-DLQ] Saved to database for manual review.");
